  ...
  return (
    ...
    <form 
      ...
      <label>
        <span className='font-satoshi font-semibold text-base text-gray-700'>
          ...
          <span className='font-normal'>
            (#product, #webdevelopment, #ai, #machinelearning)
          </span></span>
      ...
      <div className='flex-end mx-3 mb-5 gap-4'>
        ...
        <button type='submit' disabled={submitting} className='px-5 py-1.5 text-sm bg-primary-orange rounded-full text-white'>{submitting ? `Submitting...` : type}</button>
      </div>
    </form>
    </section>
  )
